...
import img from "../../assets/Cs-2.jpg";
import { AboutMe } from "../../components";
import { DownloadCVButton } from "../../components/buttons";
import cv from "../../assets/cv/SHABANGU CHARMAINE.pdf";
import letter from "../../assets/cv/charmaine shabangu.pdf";
    ...
    <AboutMe>
      <AboutMe.Container>
        ...
        <AboutMe.Column>
          ...
          <AboutMe.Heading4>
            Hello! My Name is charmaine Shabangu.
          </AboutMe.Heading4>
          <AboutMe.Text>
